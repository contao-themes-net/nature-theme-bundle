...
- [Added] Add youtube video template for klaro consent manager
...
- [Changed] Include Font Awesome via `$GLOBALS['TL_CSS']['fontawesome']`
- [Changed] Change youtube video template
...
- [Changed] update bulma version (0.9.3)
- [Fixed] replace patchwork/utf8
- [Changed] set php 7.1 to minimum requirement
- [Fixed] change custom template in contao 4.13 sql file
- [Fixed] css fix for navbar dropdown background
- [Fixed] display galleries mobile single column

## [1.8.2](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.8.2) – 2022-04-01

- [Fixed] fix slider element error
...
- [Changed] update styling

## [1.4.3](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.4.3) – 2021-04-30

- [Fixed] sticky teaserbox ([#23](https://github.com/contao-themes-net/nature-theme-bundle/issues/23))

## [1.4.2](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.4.2) – 2021-03-15

- [Fixed] css fix for fullheight teaserbox ([#22](https://github.com/contao-themes-net/nature-theme-bundle/issues/22))
- [Fixed] css fixes for dark mode and breadcrumb

## [1.4.1](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.4.1) – 2021-02-15

- [Fixed] css fix for fullheight teaserbox
- [Changed] update modal template
...
- [Fixed] centered images with class has-text-centered

## [1.3.1](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.3.1) – 2020-06-26

- [Fixed] update feature element
- [Fixed] add fourth nav menu
- [Fixed] Duplicate ID navbarMain

## [1.3.0](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.3.0) – 2020-06-12

- [Added] add more padding if home slider is hidden, add ref to url in theme setup page

## [1.2.9](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.2.9) – 2020-05-04

- [Fixed] remove css list style from gallery
- [Fixed] fix links in feature element

## [1.2.8](https://github.com/contao-themes-net/nature-theme-bundle/tree/1.2.8) – 2020-04-29

- [Added] add mobile breakpoint variable
- [Fixed] fix mobile navigation bug
