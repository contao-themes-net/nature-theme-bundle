...
namespace ContaoThemesNet\NatureThemeBundle\EventListener;
...
class PreviewToolbarListener
{
    ...
    private function injectToolbar(Response $response, Request $request): void
    {
        ...
        $pos = strripos($content, 'id="naturePreviewToolbar"');
        ...
        $toolbar = $this->twig->render('@Contao_ContaoThemesNetNatureThemeBundle/Frontend/preview_toolbar.html.twig', [
            'natureColor' => $session->get('nature_color'),
        ]);
